...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Informational: number of seed runs that produced the input files. "
             "Files named success_analysis_{id}_seed_{seed}.md are parsed automatically "
             "— no structural change needed (default: 1).",
    )
